                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="estimated_hours" id="estimated_hours" class="form-control"
                                           value="{{ old('estimated_hours', $task->estimated_hours) }}" min="0" step="0.5" placeholder="0.5, 1, 2, etc.">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="actual_hours" id="actual_hours" class="form-control"
                                           value="{{ old('actual_hours', $task->actual_hours) }}" min="0" step="0.5" placeholder="0.5, 1, 2, etc.">
                                    <small class="form-text text-muted">Actual time spent on this task</small>
                                </div>
...
// Auto-fill started_at when status changes to in progress (only if empty)
document.getElementById('status').addEventListener('change', function() {
    const status = parseInt(this.value);
...
// Auto-fill completed_at when status changes to completed/resolved (only if empty)
document.getElementById('status').addEventListener('change', function() {
    const status = parseInt(this.value);
